...
const eventData = [
  ...
  // Event 4
  {
    ...
    vehicles: [],
    notes: 'Subject observed conducting hand-to-hand exchanges in Piccadilly Gardens. Search recovered 15 wraps of heroin and 23 wraps of cocaine. Cash sum of £640 also seized.',
    outcome: 'Charged',
    linkedReports: [
      {
        reference: 'CR76543',
